...
title: Build & Deploy
source: railway
url: https://docs.railway.com/build-deploy
fetched: 2026-06-21T06:36:21.206298
---
...
On this pageRailway supports three types of compute: persistent services for long-running processes like web apps and APIs, cron jobs for scheduled tasks, and functions for single-file TypeScript code.
...
[/TABLE]
[NextQuick start](/quick-start)### On this page

[Compute primitives](#compute-primitives)[Configuration](#configuration)[Builds](#builds)[Deployments](#deployments)### Ask AI about this page

Copy pageOpen in ChatGPTOpen in ClaudeOpen in Cursor[Edit this page on GitHub](https://github.com/railwayapp/docs/edit/main/content/docs/build-deploy.md)Last updated Jun 20, 2026