...
fetched: 2026-06-21T06:33:10.510753
---
...
Easiest path: Nous PortalOne subscription covers 300+ models plus the [Tool Gateway](/docs/user-guide/features/tool-gateway) (web search, image generation, TTS, cloud browser). On a fresh install:
...
Setup modesOn a fresh install, `hermes setup` offers three modes:
...
[Edit this page](https://github.com/NousResearch/hermes-agent/edit/main/website/docs/getting-started/quickstart.md)[PreviousUser Stories & Use Cases](/docs/user-stories)[NextInstallation](/docs/getting-started/installation)
* [Prefer to watch?](#prefer-to-watch)
* [Who this is for](#who-this-is-for)
* [The fastest path](#the-fastest-path)
* [1. Install Hermes Agent](#1-install-hermes-agent)
