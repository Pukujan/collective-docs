---
title: FIM (Fill-in-the-Middle) Completion
source: deepseek
url: https://api-docs.deepseek.com/guides/fim_completion
fetched: 2026-06-21T06:38:47.735350
---
...
On this page# FIM Completion (Beta)
...
[PreviousChat Prefix Completion (Beta)](/guides/chat_prefix_completion)[NextJSON Output](/guides/json_mode)
* [Notice](#notice)
* [Sample Code](#sample-code)
* [Integration With Continue](#integration-with-continue)