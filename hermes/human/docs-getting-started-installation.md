...
fetched: 2026-06-21T06:39:13.292280
---
...
### With the Hermes Desktop installer on macOS or Windows (recommended)[​](#with-the-hermes-desktop-installer-on-macos-or-windows-recommended)
...
### Without Hermes Desktop:[​](#without-hermes-desktop)
...
Fastest path: Nous PortalOne subscription covers 300+ models plus the [Tool Gateway](/docs/user-guide/features/tool-gateway) (web search, image generation, TTS, cloud browser). Skip the per-tool key juggling:
...
## Non-Sudo / System Service User Installs[​](#non-sudo--system-service-user-installs)
...
## Install method auto-detection[​](#install-method-auto-detection)
...
[Edit this page](https://github.com/NousResearch/hermes-agent/edit/main/website/docs/getting-started/installation.md)[PreviousQuickstart](/docs/getting-started/quickstart)[NextAndroid / Termux](/docs/getting-started/termux)
* [Quick Install](#quick-install)
[With the Hermes Desktop installer on macOS or Windows (recommended)](#with-the-hermes-desktop-installer-on-macos-or-windows-recommended)
* [Without Hermes Desktop:](#without-hermes-desktop)
* [What the Installer Does](#what-the-installer-does)
