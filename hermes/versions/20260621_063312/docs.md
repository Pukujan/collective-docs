...
fetched: 2026-06-21T06:33:09.797511
---
...
](/docs/getting-started/installation)[Download Desktop

](https://hermes-agent.nousresearch.com/)[View on GitHub
...
Fastest path to a working agentAfter installing, run `hermes setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/docs/integrations/nous-portal).
