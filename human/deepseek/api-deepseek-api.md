---
title: API Reference — DeepSeek API
source: deepseek
url: https://api-docs.deepseek.com/api/deepseek-api
fetched: 2026-06-21T06:39:53.769813
---

# API Reference — DeepSeek API
...
](https://opensource.org/license/mit/)[PreviousAnthropic API](/guides/anthropic_api)[NextCreate Chat Completion](/api/create-chat-completion)