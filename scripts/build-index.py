#!/usr/bin/env python3
"""
build-index.sh → build-index.py
Rebuilds the FTS5 full-text search index and the vector embedding index.
"""
...
def build_fts5():
    """Build FTS5 index from agent/ docs."""
...
def build_vector_index():
    ...
    Embeddings will be generated by a separate script that calls the DeepSeek API.
    """
