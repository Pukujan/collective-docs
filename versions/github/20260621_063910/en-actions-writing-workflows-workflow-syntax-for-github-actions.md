...
fetched: 2026-06-21T06:39:06.764408
---

# Workflow Syntax for GitHub Actions

* [GitHub Actions](/en/actions)/
* [Reference](/en/actions/reference)/
* [Workflows and actions](/en/actions/reference/workflows-and-actions)/
...
* [run-name](#run-name)
* [on](#on)
* [on..types](#onevent_nametypes)
* [on..](#onpull_requestpull_request_targetbranchesbranches-ignore)
* [on.push.](#onpushbranchestagsbranches-ignoretags-ignore)
* [on..](#onpushpull_requestpull_request_targetpathspaths-ignore)
* [on.schedule](#onschedule)
* [on.workflow_call](#onworkflow_call)
* [on.workflow_call.inputs](#onworkflow_callinputs)
* [on.workflow_call.inputs..type](#onworkflow_callinputsinput_idtype)
* [on.workflow_call.outputs](#onworkflow_calloutputs)
* [on.workflow_call.secrets](#onworkflow_callsecrets)
* [on.workflow_call.secrets.](#onworkflow_callsecretssecret_id)
* [on.workflow_call.secrets..required](#onworkflow_callsecretssecret_idrequired)
* [on.workflow_run.](#onworkflow_runbranchesbranches-ignore)
* [on.workflow_dispatch](#onworkflow_dispatch)
* [on.workflow_dispatch.inputs](#onworkflow_dispatchinputs)
* [on.workflow_dispatch.inputs..required](#onworkflow_dispatchinputsinput_idrequired)
* [on.workflow_dispatch.inputs..type](#onworkflow_dispatchinputsinput_idtype)
...
* [jobs](#jobs)
* [jobs.](#jobsjob_id)
* [jobs..name](#jobsjob_idname)
* [jobs..permissions](#jobsjob_idpermissions)
* [jobs..needs](#jobsjob_idneeds)
* [jobs..if](#jobsjob_idif)
* [jobs..runs-on](#jobsjob_idruns-on)
* [jobs..snapshot](#jobsjob_idsnapshot)
* [jobs..environment](#jobsjob_idenvironment)
* [jobs..concurrency](#jobsjob_idconcurrency)
* [jobs..outputs](#jobsjob_idoutputs)
* [jobs..env](#jobsjob_idenv)
* [jobs..defaults](#jobsjob_iddefaults)
* [jobs..defaults.run](#jobsjob_iddefaultsrun)
* [jobs..defaults.run.shell](#jobsjob_iddefaultsrunshell)
* [jobs..defaults.run.working-directory](#jobsjob_iddefaultsrunworking-directory)
* [jobs..steps](#jobsjob_idsteps)
* [jobs..steps[*].id](#jobsjob_idstepsid)
* [jobs..steps[*].if](#jobsjob_idstepsif)
* [jobs..steps[*].name](#jobsjob_idstepsname)
* [jobs..steps[*].uses](#jobsjob_idstepsuses)
* [jobs..steps[*].run](#jobsjob_idstepsrun)
* [jobs..steps[*].working-directory](#jobsjob_idstepsworking-directory)
* [jobs..steps[*].shell](#jobsjob_idstepsshell)
* [jobs..steps[*].with](#jobsjob_idstepswith)
* [jobs..steps[*].with.args](#jobsjob_idstepswithargs)
* [jobs..steps[*].with.entrypoint](#jobsjob_idstepswithentrypoint)
* [jobs..steps[*].env](#jobsjob_idstepsenv)
* [jobs..steps[*].continue-on-error](#jobsjob_idstepscontinue-on-error)
* [jobs..steps[*].timeout-minutes](#jobsjob_idstepstimeout-minutes)
* [jobs..timeout-minutes](#jobsjob_idtimeout-minutes)
* [jobs..strategy](#jobsjob_idstrategy)
* [jobs..strategy.matrix](#jobsjob_idstrategymatrix)
* [jobs..strategy.matrix.include](#jobsjob_idstrategymatrixinclude)
* [jobs..strategy.matrix.exclude](#jobsjob_idstrategymatrixexclude)
* [jobs..strategy.fail-fast](#jobsjob_idstrategyfail-fast)
* [jobs..strategy.max-parallel](#jobsjob_idstrategymax-parallel)
* [jobs..continue-on-error](#jobsjob_idcontinue-on-error)
* [jobs..container](#jobsjob_idcontainer)
* [jobs..container.image](#jobsjob_idcontainerimage)
* [jobs..container.credentials](#jobsjob_idcontainercredentials)
* [jobs..container.env](#jobsjob_idcontainerenv)
* [jobs..container.ports](#jobsjob_idcontainerports)
* [jobs..container.volumes](#jobsjob_idcontainervolumes)
* [jobs..container.options](#jobsjob_idcontaineroptions)
* [jobs..services](#jobsjob_idservices)
* [jobs..services..image](#jobsjob_idservicesservice_idimage)
* [jobs..services..credentials](#jobsjob_idservicesservice_idcredentials)
* [jobs..services..env](#jobsjob_idservicesservice_idenv)
* [jobs..services..ports](#jobsjob_idservicesservice_idports)
* [jobs..services..volumes](#jobsjob_idservicesservice_idvolumes)
* [jobs..services..options](#jobsjob_idservicesservice_idoptions)
* [jobs..services..command](#jobsjob_idservicesservice_idcommand)
* [jobs..services..entrypoint](#jobsjob_idservicesservice_identrypoint)
* [jobs..uses](#jobsjob_iduses)
* [jobs..with](#jobsjob_idwith)
* [jobs..with.](#jobsjob_idwithinput_id)
* [jobs..secrets](#jobsjob_idsecrets)
* [jobs..secrets.inherit](#jobsjob_idsecretsinherit)
* [jobs..secrets.](#jobsjob_idsecretssecret_id)
...
For information on how to reference a job output, see [`jobs..outputs`](#jobsjob_idoutputs). For more information, see [Reuse workflows](/en/actions/using-workflows/reusing-workflows).
...
If you are passing the secret to a nested reusable workflow, then you must use [`jobs..secrets`](#jobsjob_idsecrets) again to pass the secret. For more information, see [Reuse workflows](/en/actions/using-workflows/reusing-workflows#passing-secrets-to-nested-workflows).
...
You can use `permissions` to modify the default permissions granted to the `GITHUB_TOKEN`, adding or removing access as required, so that you only allow the minimum required access. For more information, see [Use GITHUB_TOKEN for authentication in workflows](/en/actions/security-guides/automatic-token-authentication#modifying-the-permissions-for-the-github_token).


You can use `permissions` either as a top-level key, to apply to all jobs in the workflow, or within specific jobs. When you add the `permissions` key within a specific job, all actions and run commands within that job that use the `GITHUB_TOKEN` gain the access rights you specify. For more information, see [`jobs..permissions`](/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_idpermissions).
...
A `map` of variables that are available to the steps of all jobs in the workflow. You can also set variables that are only available to the steps of a single job or to a single step. For more information, see [`jobs..env`](#jobsjob_idenv) and [`jobs..steps[*].env`](#jobsjob_idstepsenv).
...
Use `defaults` to create a `map` of default settings that will apply to all jobs in the workflow. You can also set default settings that are only available to a job. For more information, see [`jobs..defaults`](/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_iddefaults).
...
You can use `defaults.run` to provide default `shell` and `working-directory` options for all [`run`](/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_idstepsrun) steps in a workflow. You can also set default settings for `run` that are only available to a job. For more information, see [`jobs..defaults.run`](/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_iddefaultsrun). You cannot use contexts or expressions in this keyword.
...
You can also specify `concurrency` at the job level. For more information, see [`jobs..concurrency`](/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_idconcurrency).
...
### [Example: Queueing multiple pending runs](#example-queueing-multiple-pending-runs)
...
Use `jobs.` to give your job a unique identifier. The key `job_id` is a string and its value is a map of the job's configuration data. You must replace `` with a string that is unique to the `jobs` object. The `` must start with a letter or `_` and contain only alphanumeric characters, `-`, or `_`.
...
Use `jobs..name` to set a name for the job, which is displayed in the GitHub UI.


## [`jobs..permissions`](#jobsjob_idpermissions)


For a specific job, you can use `jobs..permissions` to modify the default permissions granted to the `GITHUB_TOKEN`, adding or removing access as required, so that you only allow the minimum required access. For more information, see [Use GITHUB_TOKEN for authentication in workflows](/en/actions/security-guides/automatic-token-authentication#modifying-the-permissions-for-the-github_token).
...
The `jobs..if` condition is evaluated before [`jobs..strategy.matrix`](/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_idstrategymatrix) is applied.
...
Use `jobs..runs-on` to define the type of machine to run the job on.
...
*
If you would like to run your workflow on multiple machines, use [`jobs..strategy`](/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_idstrategy).
...
[TABLE]
    ...
    |
       ...
       14 GB
        ...
        `[ubuntu-26.04](https://github.com/actions/runner-images/blob/main/images/ubuntu/Ubuntu2604-Readme.md)` (Public preview)
    ...
    |
       ...
       14 GB
        ...
        `[ubuntu-26.04-arm](https://github.com/actions/runner-images/blob/main/images/ubuntu/Ubuntu2604-Arm64-Readme.md)` (Public preview)
    ...
    |
       ...
       arm64
        ...
        `[windows-11-arm](https://github.com/actions/runner-images/blob/main/images/windows/Windows11-Arm64-Readme.md)`,
        `[windows-11-vs2026-arm](https://github.com/actions/runner-images/blob/main/images/windows/Windows11-VS2026-Arm64-Readme.md)` (Public preview)
    ...
    |
       ...
       14 GB
        ...
        `[macos-26-intel](https://github.com/actions/runner-images/blob/main/images/macos/macos-26-Readme.md)`
    ...
    |
       ...
       14 GB
        ...
        `[macos-15](https://github.com/actions/runner-images/blob/main/images/macos/macos-15-arm64-Readme.md)`,
...
[TABLE]
    ...
    |
       ...
       14 GB
        ...
        `[windows-11-arm](https://github.com/actions/runner-images/blob/main/images/windows/Windows11-Arm64-Readme.md)`,
        `[windows-11-vs2026-arm](https://github.com/actions/runner-images/blob/main/images/windows/Windows11-Arm64-VS2026-Readme.md)` (Public preview)
...
You can use `jobs..snapshot` to generate a custom image.
...
Use `jobs..environment` to define the environment that the job references.
...
### [Example: Queueing multiple pending runs](#example-queueing-multiple-pending-runs-1)
...
You can use `jobs..outputs` to create a `map` of outputs for a job. Job outputs are available to all downstream jobs that depend on this job. For more information on defining job dependencies, see [`jobs..needs`](/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_idneeds).
...
A `map` of variables that are available to all steps in the job. You can set variables for the entire workflow or an individual step. For more information, see [`env`](#env) and [`jobs..steps[*].env`](#jobsjob_idstepsenv).


When more than one environment variable is defined with the same name, GitHub uses the most specific variable. For example, an environment variable defined in a step will override job and workflow environment variables with the same name, while the step executes. An environment variable defined for a job will override a workflow variable with the same name, while the job executes.


### [Example of `jobs..env`](#example-of-jobsjob_idenv)
...
Use `jobs..defaults` to create a `map` of default settings that will apply to all steps in the job. You can also set default settings for the entire workflow. For more information, see [`defaults`](/en/actions/using-workflows/workflow-syntax-for-github-actions#defaults).
...
Use `jobs..defaults.run` to provide default `shell` and `working-directory` to all `run` steps in the job.
...
These can be overridden at the `jobs..defaults.run` and `jobs..steps[*].run` levels.
...
### [Example of `jobs..steps`](#example-of-jobsjob_idsteps)
...
Alternatively, you can specify a default working directory for all `run` steps in a job, or for all `run` steps in the entire workflow. For more information, see [`defaults.run.working-directory`](/en/actions/using-workflows/workflow-syntax-for-github-actions#defaultsrunworking-directory) and [`jobs..defaults.run.working-directory`](/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_iddefaultsrunworking-directory).
...
Input parameters defined for a Docker container must use `args`. For more information, see [`jobs..steps[*].with.args`](#jobsjob_idstepswithargs).


### [Example of `jobs..steps[*].with`](#example-of-jobsjob_idstepswith)
...
### [Example of `jobs..steps[*].with.args`](#example-of-jobsjob_idstepswithargs)
...
### [Example of `jobs..steps[*].with.entrypoint`](#example-of-jobsjob_idstepswithentrypoint)
...
Sets variables for steps to use in the runner environment. You can also set variables for the entire workflow or a job. For more information, see [`env`](#env) and [`jobs..env`](#jobsjob_idenv).
...
### [Example of `jobs..steps[*].env`](#example-of-jobsjob_idstepsenv)
...
The `GITHUB_TOKEN` expires when a job finishes or after a maximum of 24 hours. For self-hosted runners, the token may be the limiting factor if the job timeout is greater than 24 hours. For more information on the `GITHUB_TOKEN`, see [Use GITHUB_TOKEN for authentication in workflows](/en/actions/security-guides/automatic-token-authentication#about-the-github_token-secret).


## [`jobs..strategy`](#jobsjob_idstrategy)


Use `jobs..strategy` to use a matrix strategy for your jobs. A matrix strategy lets you use variables in a single job definition to automatically create multiple job runs that are based on the combinations of the variables. For example, you can use a matrix strategy to test your code in multiple versions of a language or on multiple operating systems. For more information, see [Running variations of jobs in a workflow](/en/actions/using-jobs/using-a-matrix-for-your-jobs).


## [`jobs..strategy.matrix`](#jobsjob_idstrategymatrix)


Use `jobs..strategy.matrix` to define a matrix of different job configurations. For more information, see [Running variations of jobs in a workflow](/en/actions/how-tos/writing-workflows/choosing-what-your-workflow-does/running-variations-of-jobs-in-a-workflow).
...
You can control how job failures are handled with `jobs..strategy.fail-fast` and `jobs..continue-on-error`.
...
`jobs..continue-on-error` applies to a single job. If `jobs..continue-on-error` is `true`, other jobs in the matrix will continue running even if the job with `jobs..continue-on-error: true` fails.
...
The default shell for `run` steps inside a container is `sh` instead of `bash`. This can be overridden with [`jobs..defaults.run`](/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_iddefaultsrun) or [`jobs..steps[*].shell`](/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_idstepsshell).
...
Use `jobs..container.image` to define the Docker image to use as the container to run the action. The value can be the Docker Hub image name or a registry name.
...
If the image's container registry requires authentication to pull the image, you can use `jobs..container.credentials` to set a `map` of the `username` and `password`. The credentials are the same values that you would provide to the [`docker login`](https://docs.docker.com/engine/reference/commandline/login/) command.
...
Use `jobs..container.env` to set a `map` of environment variables in the container.


## [`jobs..container.ports`](#jobsjob_idcontainerports)


Use `jobs..container.ports` to set an `array` of ports to expose on the container.


## [`jobs..container.volumes`](#jobsjob_idcontainervolumes)


Use `jobs..container.volumes` to set an `array` of volumes for the container to use. You can use volumes to share data between services or other steps in a job. You can specify named Docker volumes, anonymous Docker volumes, or bind mounts on the host.
...
Use `jobs..container.options` to configure additional Docker container resource options. For a list of options, see [`docker create` options](https://docs.docker.com/engine/reference/commandline/create/#options).
...
This example creates two services: nginx and redis. When you specify the container port but not the host port, the container port is randomly assigned to a free port on the host. GitHub sets the assigned host port in the `${{job.services..ports}}` context. In this example, you can access the service host ports using the `${{ job.services.nginx.ports['80'] }}` and `${{ job.services.redis.ports['6379'] }}` contexts.
...
If `jobs..services..image` is assigned an empty string, the service will not start. You can use this to set up conditional services, similar to the following example.
...
### [Example of `jobs..services..credentials`](#example-of-jobsjob_idservicesservice_idcredentials)
...
### [Example of `jobs..services..volumes`](#example-of-jobsjob_idservicesservice_idvolumes)
...
### [Example of `jobs..services..command`](#example-of-jobsjob_idservicesservice_idcommand)
...
### [Example of `jobs..services..entrypoint`](#example-of-jobsjob_idservicesservice_identrypoint)
...
### [Example of `jobs..uses`](#example-of-jobsjob_iduses)
...
Unlike [`jobs..steps[*].with`](#jobsjob_idstepswith), the inputs you pass with `jobs..with` are not available as environment variables in the called workflow. Instead, you can reference the inputs by using the `inputs` context.


### [Example of `jobs..with`](#example-of-jobsjob_idwith)
...
A pair consisting of a string identifier for the input and the value of the input. The identifier must match the name of an input defined by [`on.workflow_call.inputs.`](/en/actions/creating-actions/metadata-syntax-for-github-actions#inputsinput_id) in the called workflow. The data type of the value must match the type defined by [`on.workflow_call.inputs..type`](#onworkflow_callinputsinput_idtype) in the called workflow.
...
### [Example of `jobs..secrets`](#example-of-jobsjob_idsecrets)
...
### [Example of `jobs..secrets.inherit`](#example-of-jobsjob_idsecretsinherit)
